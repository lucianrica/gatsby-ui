    ...
    return (
        <footer className={styles.footer}>
            ...
            <div>
                ...
                <a href={`${contributeUrl}/README.md`} className={styles.btn} target="_blank">
                    Make a contribution</a>
                <a href={`${baseUrl}/blob/main/CONTRIBUTING.md`} className={`${styles.link} ${styles.small}`} target="_blank">
